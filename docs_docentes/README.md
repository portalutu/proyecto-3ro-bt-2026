# Carpeta de documentación docente

En esta carpeta se encuentran documentos de ayuda y templates para usar en el proyecto final.
...
1. [Project Charter](01_project_charter.md) — acta de constitución del proyecto.
2. [Épicas y requerimientos](02_epicas_y_requerimientos.md) — requerimientos funcionales, no funcionales y épicas.
3. [Historias de usuario](03_historias_de_usuario.md) — formato, criterios de aceptación y estimación.
4. [Backlog por sprint](04_backlog_por_sprint.md) — Product Backlog priorizado y detalle de cada sprint.
